                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{\Illuminate\Support\Facades\Auth::user()->username}}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">ایمیل الکترونیک</label>
                                            <input type="email" class="form-control" value="{{\Illuminate\Support\Facades\Auth::user()->email}}" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{$ostan ?? ''}}" name="ostan">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">شهر</label>
                                            <input type="text" class="form-control" placeholder="{{$shahr ?? ''}}" name="shahr">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="bmd-label-floating">در چند خط شخصیت خود را معرفی کنید.</label>
                                                <textarea class="form-control" rows="5" placeholder="{{$about_me ?? ''}}" name="about_me"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
